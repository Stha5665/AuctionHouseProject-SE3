...
@section('pageName', 'Edit Catalogue')
...
<x-app-layout>
    ...
    <div class="card bg-white p-3 mx-auto">
        ...
        <div class="card-header">
            ...
            {{--            or the header--}}
            <h1 class="text-center display-6 ">Edit Catalogue</h1>
        </div>
        ...
        <div class="card-body">
            ...
            <form class="form-control" method="POST" action="{{route('catalogues.update', $catalogueDetailData ->id)}}">
                @method('PUT')
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-2">
                        ...
                        {{--                        input type text--}}
                        <input type="text" class="form-control" name="title" value="{{$catalogueDetailData->title}}" required>
                    ...
                    <div class="col-md-6 mt-2">
                        ...
                        {{--                        input type text--}}
                        <input type="number" class="form-control" name="lot_number" value="{{$catalogueDetailData->lot_number}}" min="1" required>
                        {{--                        This for showing error message--}}
                        @error('lot_number')
                        <span class="text-bg-danger">{{$message}}</span>
                        @enderror
                    ...
                    <div class="col-md-6 mt-2">
                        ...
                        {{--                        input type text--}}
                        <input type="number" class="form-control" name="estimated_price" value="{{$catalogueDetailData->estimated_price}}" min="1" required>
                        {{--                        This for showing error message--}}
                    ...
                    <div class="col-md-12 mt-2">
                        ...
                        <textarea class="form-control" name="description" rows="5">{{$catalogueDetailData->description}}</textarea>
                    ...
                    <div class="col-md-12 mt-2">
                        ...
                        <select class="form-control" name="item_id" required>
                            @forelse($itemNames as $itemName)
                                <option value="{{$itemName->id}}" {{$catalogueDetailData->item_id == $itemName->id ? 'selected':''}}>{{$itemName->name}}</option>
                            @empty
                    ...
                    <div class="col-md-12 mt-2">
                        ...
                        <select class="form-control" name="is_archived">
                            <option value="yes" {{$catalogueDetailData->is_archived == 'yes' ? 'selected':''}}>Yes</option>
                            <option value="no"{{$catalogueDetailData->is_archived == 'no' ? 'selected':''}}>No</option>
                        </select>
                        @error('is_archived')
                        <span class="text-bg-danger">{{$message}}</span>
                        @enderror
